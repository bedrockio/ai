...
How many calories are in a medium apple?
  ...
  describe('schema + tools', () => {
    ...
    it('should expose the schema tool input as result on the stream stop event', async () => {
      setResponse([
        {
          type: 'message_start',
          message: {
      ...
      expect(stopEvent.result).toEqual({ foods: [{ name: 'banana' }] });
    });
